...
def replace_large_with_inf(df):
    ...
    return df
# TODO: Check if correct
def data_cleaning(data:str, requirement_data_frame:pd.DataFrame, scip=False, debuggen=False):
    # fico columns
...
def main(scip=False, fico=True):
    requirement_df = pd.read_csv('/Users/fritz/Downloads/ZIB/Master/JulyTry/Bases/requirements.csv', delimiter=';')
